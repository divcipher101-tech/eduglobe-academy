            ...
            <form action={handleSaveProfile} className="space-y-8 animate-fade-in-up" autoComplete="off">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 pb-8 border-b border-glass-border">
                <div className="relative group cursor-pointer">
                  {user.avatarUrl ? (
                    <img src={user.avatarUrl} alt="Avatar" className="w-24 h-24 rounded-full border-4 border-white shadow-md object-cover" />
                  ) : (
                ...
                <div>
                  <button type="button" className="btn btn-secondary mb-2">Upload new avatar</button>
