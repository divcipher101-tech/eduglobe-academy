          ...
          <div className="flex items-center gap-3">
            {session ? (
              ...
              <>
                ...
                <Link href="/register/student" className="px-5 py-2.5 rounded-xl bg-primary-600 text-white text-sm font-bold hover:bg-primary-500 transition-all shadow-lg shadow-primary-500/20 hover:shadow-xl hover:shadow-primary-500/30 hover:-translate-y-0.5">
                  Sign up free
                </Link>
              </>
            )}
